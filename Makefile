...
CC = gcc # C compiler
CFLAGS = -Wall -Wextra -g -O2 # C flags
...
SRCS = src/encode.c src/vector.c src/video.c src/pd.c src/quaternion.c src/position.c src/motor.c src/robot.c src/control_panel.c src/coord.c src/turret.c src/matrix.c src/ogl.c
